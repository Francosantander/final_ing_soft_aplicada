package com.ar.edu.um.isa.library.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.ar.edu.um.isa.library.service.EmailAlreadyUsedException ||
            ex instanceof com.ar.edu.um.isa.library.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.ar.edu.um.isa.library.service.InvalidPasswordException
