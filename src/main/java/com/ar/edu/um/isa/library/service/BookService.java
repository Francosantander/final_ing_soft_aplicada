...
/**
 * Service Interface for managing {@link com.ar.edu.um.isa.library.domain.Book}.
 */
public interface BookService {
    ...
    /**
     * Get all the BookDTO where BorrowedBook is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<BookDTO> findAllWhereBorrowedBookIsNull();
