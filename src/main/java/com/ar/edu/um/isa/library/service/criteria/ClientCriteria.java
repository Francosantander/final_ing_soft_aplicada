...
/**
 * Criteria class for the {@link com.ar.edu.um.isa.library.domain.Client} entity. This class is used
 * in {@link com.ar.edu.um.isa.library.web.rest.ClientResource} to receive all the possible filtering options from
...
public class ClientCriteria implements Serializable, Criteria {
    ...
    public ClientCriteria(ClientCriteria other) {
        ...
        this.borrowedBookId = other.borrowedBookId == null ? null : other.borrowedBookId.copy();
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, address, phone, borrowedBookId, distinct);
    }
    ...
    public String toString() {
        return "ClientCriteria{" +
            ...
            (borrowedBookId != null ? "borrowedBookId=" + borrowedBookId + ", " : "") +
